...
## Summary
在 `C:\Users\931108boy\Desktop\WSN` 內建立實驗系統，使用提供的 MyWSN 程式作為基礎，進行參考 ZHENG single-WCV 架構的延伸實驗；目前 BP&R 部分是 BP&R-inspired risk-based proactive，不是完整 ZHENG Algorithm 3 重現。
